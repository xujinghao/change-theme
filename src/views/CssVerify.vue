<template>
  <div class="grid theme-container" ref="container">
    <div class="content">
      <div class="demo">
        <label class="switch">
          <input type="checkbox" class="theme-switcher" v-model="value" />
...
export default {
  ...
  watch: {
    value(val) {
      let themeContainer = this.$refs.container;
      if (themeContainer && val) {
...
:root {
  ...
  /* dark */
  --c-dark-background: linear-gradient(
      to bottom,
